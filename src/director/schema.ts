...
const FinisherSchema = Schema.Struct({
  ...
  clue: Schema.Literal(
    "Player A holds FIST. Player B tears with HANDS APART. Player A finishes with THRUST.",
    "Anchor with Player A's FIST, split the veil with Player B's HANDS APART, then THRUST.",
    "FIST from A. HANDS APART from B. One final THRUST from A.",
  ),
});
