...
import { ARENA_SCENE_URL, arenaAssetUrlsForRound, STARTUP_ASSET_URLS } from "./assets";
...
describe("arena asset manifests", () => {
  it("loads only the arena and Embermaw animations at startup", () => {
    expect(STARTUP_ASSET_URLS).toEqual([ARENA_SCENE_URL, ...ROUND_ANIMATION_URLS.EMBERMAW]);
